...
public class NLPThreadEng extends Thread {
    ...
    String dict_path =System.getProperty("user.dir") + file_sep+"src"+file_sep+ "main"+file_sep+"java"+ file_sep+"pl"+file_sep+"edu"+file_sep+"agh"+file_sep+"ki"+file_sep+"to2"+file_sep+"nlprocessor"+file_sep+"dictionaryEng";
